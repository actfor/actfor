...
// messages
import { congressHR1027 } from './../messages';
...
class HR1027 extends Component {
  render() {
    const steps = [
      {
        type: 'other',
        ...
        segment: renderGovTrackSegment("https://www.govtrack.us/congress/bills/116/hres1027"),
      },
      {
        type: 'name',
        name: 'Step 1',
