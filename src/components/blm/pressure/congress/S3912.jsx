...
// messages
import { congressS3912 } from './../messages';
    ...
    const steps = [
      {
        ...
        segment: renderGovTrackSegment("https://www.govtrack.us/congress/bills/116/hr7120"),
      },
      {
        type: 'name',
        name: 'Step 1',
