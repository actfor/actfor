...
const activists = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          Deborah Axt is Co-Executive Director of Make the Road New York. Deborah leads Make the Road’s low-wage worker organizing and policy work, as well as the organization’s 50-person legal department, all other education and survival services, and finance and development operations.          
        </p>
      </div>
    ),
  },
