...
// messages
import { congressS3471 } from '../messages';
    ...
    const steps = [
      {
        ...
        segment: renderGovTrackSegment("https://www.govtrack.us/congress/bills/116/s3471"),
      },
      {
        type: 'name',
        name: 'Step 1',
